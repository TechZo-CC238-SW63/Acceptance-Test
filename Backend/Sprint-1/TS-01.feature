Feature: TS01 - Api User
  ...
  Scenario: Diseño de la API User
    ...
    When diseñe la API para gestionar usuarios en nuestra aplicación móvil
  ...
  Scenario: Selección de la tecnología para la API
    Given el usuario developer está diseñando la API para gestionar usuarios en nuestra aplicación móvil
